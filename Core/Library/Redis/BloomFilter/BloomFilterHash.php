...
class BloomFilterHash
{
	 ...
	 */
	public function JSHash($string, $len = null): int
    {
		$hash = 1315423911;
	 ...
	 */
	public function PJWHash($string, $len = null): int
    {
	 ...
	 */
	public function ELFHash($string, $len = null): int
    {
		$hash = 0;
		$len || $len = strlen($string);
		for ($i=0; $i<$len; $i++) {
	 ...
	 */
	public function SDBMHash($string, $len = null): int
    {
		$hash = 0;
		$len || $len = strlen($string);
		for ($i=0; $i<$len; $i++) {
	 ...
	 */
	public function DEKHash($string, $len = null): int
    {
		$len || $len = strlen($string);
		$hash = $len;
		for ($i=0; $i<$len; $i++) {
	 ...
	 */
	public function FNVHash($string, $len = null): int
    {
